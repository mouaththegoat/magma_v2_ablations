...
3. (A5 ablation: data_worker_validator is disabled.) Call inspect_run_contract. If DATA_HANDOFF.json exists, proceed directly to step 4. If DATA_ERROR.json exists or DATA_HANDOFF.json is missing, call decide_repair_route before deciding whether to rerun data, ask human, degrade, or fail.
...
6. (A5 ablation: model_worker_validator is disabled.) After MODEL_HANDOFF.json exists, proceed directly to call_judge without calling any validator.
