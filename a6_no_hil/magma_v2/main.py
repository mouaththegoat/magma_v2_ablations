...
from magma_v2.agents.orchestrator import orchestrator
...
async def run(
    ...
    try:
        ...
        while should_retry:
            ...
            # A6 ablation: no HIL — skip plan_initial_human_clarification and all human-input
            # collection loops. Build the orchestrator prompt directly from the user request.
            human_answers = ""
            ...
            below_threshold = reward is None or reward < REWARD_THRESHOLD
