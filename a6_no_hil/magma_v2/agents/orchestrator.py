...
Human-in-the-loop policy (A6 ablation: HIL is disabled):
- Do NOT ask the human any clarification questions under any circumstances.
- Do NOT call ask_human_question (it is not available).
- Proceed with whatever information is present in the user prompt. If a decision cannot be made defensibly, make the most reasonable inference and document it in the final report as a limitation.
